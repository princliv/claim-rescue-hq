...
export default function StartSimulationModal({ visible, onEnterGame, onReadMore }: Props) {
  return (
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-[#0a0f18]/60 backdrop-blur-xl"
        >
          <motion.div
            ...
            className="bg-white/95 backdrop-blur-3xl border border-white/40 rounded-[42px] shadow-[0_50px_100px_rgba(0,0,0,0.3)] max-w-md w-full overflow-hidden relative"
          >
            {/* Top Accent Bar */}
            ...
            <div className="p-10 flex flex-col items-center text-center">
              ...
              <motion.div
                ...
                className="w-20 h-20 rounded-3xl bg-primary/10 text-primary flex items-center justify-center mb-8 shadow-inner ring-1 ring-primary/20"
              >
                <ShieldCheck size={40} />
              </motion.div>
              ...
              <p className="text-[13px] font-mono font-medium text-slate-500 leading-relaxed mb-10 max-w-[280px]">
                Initialize your clinical training cycle or explore the analytical suite manual.
              </p>
